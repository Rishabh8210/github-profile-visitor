...
const Sidebar = () => {
  ...
  return (
    <div className='h-screen pl-10 flex flex-col gap-4 overflow-scroll w-72 border-2 border-t-0 flex-shrink-0'>
        <div className='flex items-center gap-6'>
          ...
          <span className='h-6 w-6 bg-blue-600 flex items-center justify-center text-white rounded-md'>1</span>
        </div>
        <div className='flex items-center gap-6'>
          <div className='h-16 w-fit flex gap-4 items-center'>
            <img className='h-7 ' src={Repo} alt='-'/>
